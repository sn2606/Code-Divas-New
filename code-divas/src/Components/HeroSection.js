...
function HeroSection() {
    return (
        ...
        <div className="hero-container"> 
           ...
           <p className="justify-center">Our project aims to help empower women who do not have conventional/formal education, are housewives that are completely dependent on their significant other, or belong to the economically deprived classes. 
